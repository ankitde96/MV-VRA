...
- **Reviewer-experience upgrade Stages 0–5 complete and verified.** Stage 0 decomposes the
  ...
  journeys passed 4/4. Stage 4 fixes the confirmed internal-reviewer evidence 401 with a
  separate tenant-scoped route, displays complete evidence metadata, supports atomic
  advisory insufficiency annotations, integrates them into the missing-evidence facet, and
