 ...
 *
 * The redesign keeps this header opaque and border-first while preserving the portal's
 * low-density, plain-language surface for infrequent external users.
 */
export default function PortalLayout({
  ...
  return (
    <div className="bg-background min-h-screen text-base">
      <header className="border bg-card sticky top-0 z-(--z-nav) flex h-16 items-center gap-2 px-6">
