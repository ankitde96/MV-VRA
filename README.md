...
| `npm run db:seed-demo`                          | Optional, repeatable 12-vendor reviewer/reporting dataset with deterministic verdicts, evidence, linked risks/CAPs, and a correction round. Use `npm run db:seed-demo -- --reset` to clear its dedicated evidence-storage prefix before rebuilding.       |
